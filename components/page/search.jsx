    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="flex items-center relative z-10 w-full">
                ...
                <Input ref={inpRef} value={query} onChange={(e) => setQuery(e.target.value)} autoComplete="off" type="search" className="rounded-lg bg-secondary/50" name="query" placeholder="Try Nakhre by ZackKnight.." />
            </form>
        </>
    )
}
