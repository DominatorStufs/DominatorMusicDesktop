...
export default function LibraryPage() {
    ...
    return (
        <PageShell>
            <div className="mb-2">
                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight flex items-center gap-2"><Heart className="h-6 w-6" /> Your Library</h1>
            ...
            <div className="mt-10">
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <h2 className="text-lg font-semibold tracking-tight flex items-center gap-2"><BarChart3 className="h-4 w-4" /> Your Stats</h2>
            ...
            {/* Liked Songs */}
            <div className="mt-10">
                <h2 className="text-lg font-semibold tracking-tight">Liked Songs</h2>
                ...
                {liked.length ? (
                    ...
                    <div className="rounded-xl border border-dashed border-border py-10 text-center">
                        ...
                        <p className="text-xs text-muted-foreground mt-0.5">Tap the heart on any song to save it here.</p>
                    </div>
                )}
            </div>
            ...
            <div className="mt-14">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-lg font-semibold tracking-tight flex items-center gap-2"><ListMusic className="h-4 w-4" /> Playlists</h2>
                ...
                {playlists.length ? (
                    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 mt-4">
                        {playlists.map((p) => (
                            <div key={p.id} className="rounded-xl border border-border bg-secondary/40 p-4 transition hover:bg-secondary/70 hover:border-border/80">
                                <div className="flex items-center justify-between">
